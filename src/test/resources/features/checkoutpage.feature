...
Feature: Checkout Page Feature
  ...
  Scenario: Place Order: Login before Checkout
    When  I Click on Signup or Login button
    And   I Enter name "Prish"
    And   I Enter email address "prish123@gmail.com"
    And   I Click on Signup button
    Then  I Verify that 'ENTER ACCOUNT INFORMATION' is visible
    And   I Fill details: Title "Mr." Password "prish123" Day "4" Month "March" Year "2015"
    And   I Select checkbox Sign up for our newsletter!
    And   I Select checkbox Receive special offers from our partners!
    And   I Fill all details: First name "Prish" Last name "Patel" Company "StarPlusLtd." Address "12, Elmore Drive" AddressTwo "Kenton Road" Country "India" State "Gujarat" City "Ahmedabad" Zipcode "320008", Mobile Number "07884111720"
    And   I Click Create Account
    Then  I Verify that an 'ACCOUNT CREATED!' is visible
    And   I Click Continue button
    Then  I Verify that a Logged in as username is visible
    ...
    Then  I Verify "Address Details" and "Review Your Order"
    And   I Enter description in comment text area "Please deliver product after 12:00pm" and click Place Order button
    And   I Enter payment details: Name on Card "Mrs Prish Patel", Card Number "4917300800000000", CVC "311", Expiration month "04" Expiration year "2026"
    And   I Click Pay and Confirm Order button for Payment
    Then  I Verify success message 'Congratulations! Your order has been confirmed!'
    And   I Click on Delete Account button
    Then  I Verify that 'ACCOUNT DELETED!' is visible and click Continue button
  ...
  Scenario: Verify address details in checkout page
    When  I Click on Signup or Login button
    And   I Enter name "Piya"
    And   I Enter email address "piya123@gmail.com"
    And   I Click on Signup button
    Then  I Verify that 'ENTER ACCOUNT INFORMATION' is visible
    And   I Fill details: Title "Mrs." Password "piya123" Day "4" Month "March" Year "2015"
    And   I Select checkbox Sign up for our newsletter!
    And   I Select checkbox Receive special offers from our partners!
    And   I Fill all details: First name "Piya" Last name "Patel" Company "StarPlusLtd." Address "12, Elmore Drive" AddressTwo "Kenton Road" Country "India" State "Gujarat" City "Ahmedabad" Zipcode "320008", Mobile Number "07884111720"
    And   I Click Create Account
    Then  I Verify that an 'ACCOUNT CREATED!' is visible
    And   I Click Continue button
    Then  I Verify that a Logged in as username is visible
